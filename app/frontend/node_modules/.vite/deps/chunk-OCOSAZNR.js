...
var Arrow = React7.forwardRef(
  __name6(function Arrow2(props, forwardedRef) {
...
var Popper = __name8((props) => {
  const { __scopePopper, children } = props;
  const [anchor, setAnchor] = React9.useState(null);
  const [placementState, setPlacementState] = React9.useState(void 0);
...
var PopperAnchor = React9.forwardRef(
  __name8(function PopperAnchor2(props, forwardedRef) {
    const { __scopePopper, virtualRef, ...anchorProps } = props;
    const context = usePopperContext(ANCHOR_NAME, __scopePopper);
    const ref = React9.useRef(null);
    const onAnchorChange = context.onAnchorChange;
    const callbackRef = React9.useCallback(
      (node) => {
        ref.current = node;
        if (node) {
          onAnchorChange(node);
...
var PopperContent = React9.forwardRef(
  __name8(function PopperContent2(props, forwardedRef) {
    ...
    const { refs, floatingStyles, placement, isPositioned, middlewareData } = useFloating({
      ...
      whileElementsMounted: __name8((...args) => {
      ...
      middleware: [
        ...
        size3({
          ...detectOverflowOptions,
          apply: __name8(({ elements, rects, availableWidth, availableHeight }) => {
...
var PopperArrow = React9.forwardRef(
  __name8(function PopperArrow2(props, forwardedRef) {
...
__name8(isNotNull, "isNotNull");
var transformOrigin = __name8((options) => ({
...
__name8(getSideAndAlignFromPlacement, "getSideAndAlignFromPlacement");
var Root2 = Popper;
...
__name11(useEffectEvent, "useEffectEvent");
...
__name12(useControllableState, "useControllableState");
...
__name12(useUncontrolledState, "useUncontrolledState");
function isFunction(value) {
  return typeof value === "function";
}
__name12(isFunction, "isFunction");
...
__name12(useControllableStateReducer, "useControllableStateReducer");
...
var VisuallyHidden = React14.forwardRef(
  __name13(function VisuallyHidden2(props, forwardedRef) {
...
//# sourceMappingURL=chunk-OCOSAZNR.js.map
